...
<html>
	...
	<body>
		...
		<div id="show-runner" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:runnerInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${runnerInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
